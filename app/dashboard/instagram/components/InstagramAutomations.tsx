...
export default function InstagramAutomations({
  ...
  // Local state (sirf is section ke andar wala)
    ...
    <section id="automations" className="scroll-mt-6">
      ...
      {!isConnected ? (
        <div className="bg-white rounded-2xl p-8 border border-dashed border-gray-200 text-center">
          <p className="text-sm text-gray-500">
            Connect Instagram first to create automations 👆
          </p>
        </div>
      ) : automations.length === 0 ? (
        ...
        >
          ...
          >
            ...
            <div className="p-6 space-y-5">
              ...
              <div>
                <label className="block text-sm font-bold text-gray-900 mb-1.5">
                  Post / Reel caption (optional)
                </label>
                <input
                  type="text"
                  value={newPostCaption}
                  onChange={(e) => setNewPostCaption(e.target.value)}
                  placeholder='e.g. "Drop LINK for the free guide 👇"'
              ...
              <div>
                ...
                <textarea
                  ...
                  placeholder="Hey! Here's your link 👉 flowchat.link/..."
                  rows={4}
                ...
                />
                <p className="text-[11px] text-gray-500 mt-1">
                  AI will rewrite this into unique variations for each user.
                </p>
              </div>
              ...
              <div className="flex items-start justify-between gap-3 p-4 rounded-xl bg-gray-50 border border-gray-100">
                <div className="flex-1">
                  ...
                  <p className="text-xs text-gray-500">
                    Ask users if they follow you before sending the link.
                  </p>
                </div>
                <button

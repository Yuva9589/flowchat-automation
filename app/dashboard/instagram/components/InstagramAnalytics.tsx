...
function generateAnalyticsData(): DayData[] {
  ...
  for (let i = 89; i >= 0; i--) {
    ...
    const baseDMs = 40 + Math.floor(Math.random() * 80);
    const dms = baseDMs + Math.floor(Math.random() * 40);
...
const topKeywords = [
  { keyword: "LINK", dms: 245, percentage: 52 },
  { keyword: "PRICE", dms: 132, percentage: 28 },
  { keyword: "OFFER", dms: 89, percentage: 20 },
];

const topPosts = [
  { caption: "Drop LINK for the free guide 👇", dms: 189, keyword: "LINK" },
  { caption: "Comment PRICE for course details", dms: 132, keyword: "PRICE" },
  { caption: "Say OFFER for 30% off 🎁", dms: 89, keyword: "OFFER" },
];

/* ============= Main Component ============= */

export default function InstagramAnalytics({ isConnected }: Props) {
  // Generate data once (memoized so it doesn't regenerate every render)
      ...
      <div className="flex items-start justify-between gap-4 mb-3 flex-wrap">
        <div>
          ...
          <p className="text-sm text-gray-500">
            Overview of your Instagram automation performance.
          </p>
        </div>
                    ...
                    {[
                      ...
                      <button
                        ...
                        className={`w-full text-left px-4 py-2.5 text-sm transition-colors flex items-center justify-between ${
                          dateRange === opt.key
                            ? "font-bold text-[#03856b] bg-[#03856b]/5"
                    ...
                    <div className="space-y-3">
                      <div>
                        ...
                        <input
                          ...
                          className="w-full px-3 py-2 rounded-lg border border-gray-200 focus:outline-none focus:ring-2 focus:ring-[#03856b]/20 focus:border-[#03856b] transition-all text-sm"
                        />
                      </div>
                      <div>
                        <label className="block text-[11px] font-semibold text-gray-700 mb-1 uppercase tracking-wider">
      ...
      {!isConnected ? (
        ...
        <div className="space-y-4">
          ...
          <div className="bg-white rounded-2xl p-5 border border-gray-100 shadow-sm">
            ...
            {/* Bar chart (scrollable when many days) */}
                        ...
                        <div className="flex-1 relative flex flex-col justify-end">
                          <div
                            ...
                            style={{
                              height: `${dmHeight}%`,
                              backgroundImage:
                                "linear-gradient(180deg, #04a085, #03856b)",
                              minHeight: "3px",
                            }}
                          />
                    ...
                    <div className="w-full h-2 rounded-full bg-gray-100 overflow-hidden">
                      <div
                        ...
                        style={{
                          width: `${k.percentage}%`,
                          backgroundImage:
                            "linear-gradient(90deg, #03856b, #04a085)",
                        }}
                      />
                    </div>
                  </div>

...
export default function FacebookSettings({
  ...
  // Automation preferences (Facebook-specific)
  const [aiRewriting, setAiRewriting] = useState(true);
  const [defaultLikeGate, setDefaultLikeGate] = useState(true);
  const [groupReplies, setGroupReplies] = useState(true);
  const [adCommentReplies, setAdCommentReplies] = useState(true);
  ...
  const handleDeleteAll = () => {
    if (
      confirm(
        "Are you sure? This will delete ALL Facebook automations permanently."
      )
    ) {
      onDeleteAllAutomations();
    }
    ...
    <section id="settings" className="scroll-mt-6">
      ...
      <div className="mb-3">
        ...
        <p className="text-sm text-gray-500">
          Configure your Facebook automation preferences.
        </p>
      </div>
      ...
      {!isConnected ? (
        <div className="bg-white rounded-2xl p-8 border border-dashed border-gray-200 text-center">
          <p className="text-sm text-gray-500">
            Connect Facebook to access settings ⚙️
          </p>
        </div>
      ) : (
          ...
          <div className="bg-white rounded-2xl p-5 md:p-6 border border-gray-100 shadow-sm">
            ...
            <div className="space-y-4">
              {[
                ...
                {
                  label: "Default Like-Gate",
                  desc: "Ask users to like your page before sending link.",
                  value: defaultLikeGate,
                  setter: setDefaultLikeGate,
                  icon: "👍",
                },
                {
                  label: "Group Comment Replies",
                  desc: "Auto-DM commenters in your Facebook Groups.",
                  value: groupReplies,
                  setter: setGroupReplies,
                  icon: "👥",
                },
                {
                  label: "Ad Comment Replies",
                  desc: "Auto-DM people who comment on your ads.",
                  value: adCommentReplies,
                  setter: setAdCommentReplies,
                  icon: "📣",
                },
              ].map((s, i) => (
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-start justify-between gap-3 flex-wrap pt-3 border-t border-red-100">
                <div className="flex-1 min-w-0">
                  ...
                  <p className="text-xs text-gray-500">
                    Permanently delete all Facebook automations. This cannot be
                    undone.
                  </p>
                </div>
                <button

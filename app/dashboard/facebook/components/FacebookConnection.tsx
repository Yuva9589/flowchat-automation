    ...
    <section id="connection" className="scroll-mt-6">
      ...
      >
        <div className="flex items-start gap-4 flex-wrap md:flex-nowrap">
          ...
          <div className="flex-1 min-w-0">
            ...
            <p className="text-sm text-gray-600 mb-3">
              {isConnected
                ? "Your Facebook Page is connected. Auto-replies running 24/7."
                : "Connect your FB Page via official Meta Business API. Secure & safe."}
            </p>

            {/* Feature pills */}
            <div className="flex flex-wrap gap-1.5">
              {[
                "Post comment auto-DM",
                "Ad comment replies",
                "Group monitoring",
                "Messenger sequences",
              ].map((feat) => (
        ...
        {isConnected && (
          <div className="mt-4 pt-4 border-t border-gray-100">
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              {[
                { label: "Page", value: "Your Brand" },
                { label: "Followers", value: "8.2K" },
                { label: "Status", value: "Active", color: "#2563eb" },
        ...
        <div className="mt-4 pt-4 border-t border-gray-100 flex items-start gap-2 text-xs text-gray-600">
          <span className="mt-0.5" style={{ color: "#2563eb" }}>
            <ShieldIcon />
          </span>
          <p>
            ...
            Flowchat uses Meta Business API — approved for automated messaging.
